...
describe('Google Search Text Assertion Test Suite', function () {
    ...
    it('TC055: should assert text-related properties in the Google Search textarea', function () {
        ...
        cy.get('textarea[name="q"]').should('have.text', 'javascript by testers talk');

        // Assertion 3: Using Cypress command to check partial text
        cy.get('textarea[name="q"]').should('contain', 'javascript by testers talk');
        ...
        cy.get('textarea[name="q"]').should('have.html', 'javascript by testers talk')
            .and('have.attr', 'value');
