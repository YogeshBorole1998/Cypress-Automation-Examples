...
describe('Example to demonstrate file upload in cypress', function () {
    ...
    it('TC013: File Upload using cypress-file-upload npm package', () => {
    ...
    it('TC014: File Upload using selectFile with select mode', () => {
        cy.visit('https://the-internet.herokuapp.com/upload')
    ...
    it('TC015: File Upload using selectFile with drag and drop mode', () => {
    ...
    it.only('TC016: Multiple file upload using selectFile', () => {
        cy.visit('https://postimages.org/')
