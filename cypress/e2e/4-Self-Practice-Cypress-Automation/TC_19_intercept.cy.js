...
describe.skip('Example to demonstrate API Mocking in Cypress using cy.intercept', () => {
    ...
    it('TC033: Mock the Tags from the API Response and then validate on UI', () => {
        cy.get('.tag-list', { timeout: 10000 })
            .should('contain', 'cypress')
            .and('contain', 'selenium')
    })

    it('TC034: Mock the Article feed from the API Response and then validate on UI', () => {
