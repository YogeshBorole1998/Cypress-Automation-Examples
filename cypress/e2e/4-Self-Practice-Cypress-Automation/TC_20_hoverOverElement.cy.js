...
describe('Example to Demostrate how to hover over element in cypress', () => {
    ...
    it('TC035: Hover and Validate Text using trigger(\'mouseover\')', function () {
    ...
    it.skip('TC036: Hover and Validate Text using invoke(\'show\')', function () {
    ...
    it('TC037: Hover and Validate Text using realHover()', function () {
