...
describe('Example to demo conditional testing in cypress', () => {
    ...
    it('TC011: Check that if you find WikiVoyage on the page, then click on it and validate (Go to If)', () => {
    ...
    it('TC012: Check that if you dont find WikiVoyage in the page, then click on Wiktionary and validate (Go to Else)', () => {
        cy.title().should('eq', 'Wikipedia')
        cy.get('body').then((body) => {
