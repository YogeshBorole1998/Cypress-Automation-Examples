...
describe('Example to demonstrate commonly used JQuery commands in cypress', () => {
    ...
    it('TC044: Check if a button is disabled or enabled', function () {
    ...
    it('TC045: Remove the disabled attribute and validate that button is enabled now', function () {
        cy.visit('https://getbootstrap.com/docs/4.0/components/buttons/#disabled-state')
        cy.get('button.btn.btn-lg.btn-primary').eq(2).then(($btn) => {
    ...
    it('TC046: Assert inner text', function () {
    ...
    it('TC047: Assert value', function () {
        cy.visit('https://testautomationpractice.blogspot.com/')
    ...
    it('TC048: Assert the value of an attribute', function () {
        cy.visit('https://testautomationpractice.blogspot.com/')
    ...
    it('TC049: Assert CSS property', function () {
